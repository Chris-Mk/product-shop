...
class UserServiceImplTest {
    ...
    void registerUser_withExistingUsername_throwsException() {
        when(mockUserRepository.findUserByUsername(anyString())).thenReturn(Optional.ofNullable(mockUser));
    ...
    void registerUser_withExistingEmail_throwsException() {
        when(mockUserRepository.findUserByEmail(anyString())).thenReturn(Optional.ofNullable(mockUser));
    ...
    void editUser_username_withExistingUsername_throwsException() {
        ...
        when(mockUserRepository.findUserByUsername(editModel.getUsername())).thenReturn(Optional.of(new User()));
    ...
    void editUser_email_withExistingEmail_throwsException() {
        ...
        when(mockPasswordEncoder.matches(editModel.getOldPassword(), mockUser.getPassword())).thenReturn(true);
        when(mockUserRepository.findUserByEmail(editModel.getEmail())).thenReturn(Optional.of(new User()));
    ...
    void editUser_withValidInputData_worksFine() {
        ...
        when(mockPasswordEncoder.matches(editModel.getOldPassword(), mockUser.getPassword())).thenReturn(true);
        when(mockUserRepository.findUserByEmail(editModel.getEmail())).thenReturn(Optional.empty());
